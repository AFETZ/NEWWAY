# valid_intersection_radar_comm_scenario
...
```bash
valid_intersection_radar_comm_scenario/run_radar_bad_link.sh
valid_intersection_radar_comm_scenario/run_radar_only.sh
valid_intersection_radar_comm_scenario/run_radar_good_link.sh
```
