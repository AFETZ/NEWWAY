...
Usage:
    python3 hardwork/visualize_collision_causality.py --run-dir ~/NEWWAY_runs/2026-04-15/intersection_natural
    python3 hardwork/visualize_collision_causality.py --run-dir ~/NEWWAY_runs/2026-04-15/intersection_natural --lang ru
"""
