...
class RealFormatFixtureTest(unittest.TestCase):
    def test_build_pipeline_on_real_style_fixture(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            shutil.copy2(fixture_root / "real_style_phy_with_sionna_nrv2x.csv", input_dir / "real_style_phy_with_sionna_nrv2x.csv")
            shutil.copy2(fixture_root / "real_style_prr_with_sionna_nrv2x.csv", input_dir / "real_style_prr_with_sionna_nrv2x.csv")

            result = build_pipeline(
                input_dir=input_dir,
                output_dir=output_dir,
                scenario="v2v-cam-exchange-sionna-nrv2x",
                run_id="real-style-001",
            )
            ...
            self.assertTrue(any(r["metric_name"] == "distance_m" and r["unit"] == "m" for r in metric_rows))
            ...
            self.assertEqual(row["run_id"], "real-style-001")
