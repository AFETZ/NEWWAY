...
- Лог: `runs/<date>/v2v-cam-exchange-sionna-nrv2x.log`
- Артефакты:
  - `runs/<date>/artifacts/v2v-cam-exchange-sionna-nrv2x_output.txt`
  - `runs/<date>/artifacts/phy_with_sionna_nrv2x.csv`
  - `runs/<date>/artifacts/prr_with_sionna_nrv2x.csv`
- Графики: `runs/<date>/figures/v2v-cam-exchange-sionna-nrv2x/*.png`
