...
- Лог: `runs/<date>/v2v-coexistence-80211p-nrv2x.log`
- Артефакты:
  - `runs/<date>/artifacts/prr_latency_ns3_coexistence_11p.csv`
  - `runs/<date>/artifacts/prr_latency_ns3_coexistence_nrv2x.csv`
  - `runs/<date>/artifacts/sinr_ni.csv`
- Графики: `runs/<date>/figures/v2v-coexistence-80211p-nrv2x/*.png`
