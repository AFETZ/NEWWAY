...
```bash
MODE=sensor_only valid_cpm_perception_scenario/run.sh
MODE=sensor_good_cpm valid_cpm_perception_scenario/run.sh
MODE=sensor_bad_cpm valid_cpm_perception_scenario/run.sh
```

Или через отдельные wrapper-скрипты:

```bash
valid_cpm_perception_scenario/run_sensor_only.sh
valid_cpm_perception_scenario/run_sensor_good_cpm.sh
valid_cpm_perception_scenario/run_sensor_bad_cpm.sh
```
