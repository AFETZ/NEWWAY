#!/usr/bin/env python3
"""Build a compact technology-comparison table for experiments/compare_tech runs."""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Summarize experiments/compare_tech matrix runs")
