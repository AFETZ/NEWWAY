...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out-dir", default="", help="Output directory (default: artifacts/truck_lane_change_intuitive)")
    return p.parse_args()
...
def main() -> int:
    ...
    out_dir = Path(args.out_dir).resolve() if args.out_dir else (artifacts / "truck_lane_change_intuitive")
