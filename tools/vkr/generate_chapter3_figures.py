...
Run directories:
  ...
  CRASH_RUN: runs/2026-03-04/valid_scenario_prr_chain_check_v2
  INTERSECTION: ~/NEWWAY_runs/2026-03-05/{live_intersection_crash,live_intersection_safe}

Output: archive/2026-05-03/vkr_manuscript/figures/figure_3_*.png
"""
...
CRASH_RUN = ROOT / "runs/2026-03-04/valid_scenario_prr_chain_check_v2"
...
def figure_3_3(run_dir: Path):
    ...
    art = run_dir / "artifacts"
    chain_path = art / "truck_lane_change_intuitive" / "intuitive_dbm_prr_maneuver_chain.csv"
...
def figure_3_6(run_dir: Path):
    ...
    art = run_dir / "artifacts"
    chain_path = art / "truck_lane_change_story" / "event_chain.csv"
